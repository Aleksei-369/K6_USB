...
% Bus object: ToAppBus_Type 
clear elems;
elems(1) = Simulink.BusElement;
elems(1).Name = 's';
elems(1).Dimensions = 5000;
elems(1).DimensionsMode = 'Fixed';
elems(1).DataType = 'double';
elems(1).Complexity = 'real';
elems(1).Min = [];
...
ToAppBus_Type = Simulink.Bus;
ToAppBus_Type.HeaderFile = '';
ToAppBus_Type.Description = '';
ToAppBus_Type.DataScope = 'Auto';
ToAppBus_Type.Alignment = -1;
ToAppBus_Type.PreserveElementDimensions = 0;
ToAppBus_Type.Elements = elems;
clear elems;
assignin('base','ToAppBus_Type', ToAppBus_Type);
